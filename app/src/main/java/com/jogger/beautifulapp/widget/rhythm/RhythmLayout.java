...
public class RhythmLayout extends HorizontalScrollView {
    ...
    private Animator smoothScrollX(int position, int duration, int startDelay, boolean isStart) {
        return AnimatorUtil.moveScrollViewToX(this, position, duration, startDelay, isStart);
    }
    ...
    private void updateItemHeightAnimator(View view, int translationY) {
        if (view != null)
            AnimatorUtil.showUpAndDownBounce(view, translationY, 180, true, true);
    }
    ...
    public Animator shootDownItem(View view, boolean isStart) {
        if (view != null)
            return AnimatorUtil.showUpAndDownBounce(view, mMaxTranslationHeight, 350, isStart, true);
        return null;
    }
    ...
    public Animator bounceUpItem(View view, boolean isStart) {
        if (view != null)
            return AnimatorUtil.showUpAndDownBounce(view, 10, 350, isStart, true);
        return null;
    }
